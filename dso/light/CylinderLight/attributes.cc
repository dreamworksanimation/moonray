...
RDL2_DSO_ATTR_DEFINE(rdl2::Light)
    ...
    sceneClass.setMetadata(attrHeight, rdl2::SceneClass::sComment,
        "The height of the cylinder as measured along its axis.");
    ...
    sceneClass.setMetadata(attrSidedness, rdl2::SceneClass::sComment,
        "When set to 0 (regular), light is emitted from the outward-facing surface of the cylinder. "
        "When set to 1 (reverse), light is emitted from the inward-facing surface of the cylinder. "
        "There is no mode for emitting from both surfaces at the same time, but two cylinder lights "
