...
RDL2_DSO_ATTR_DECLARE
    rdl2::AttributeKey<rdl2::SceneObject*> attrLight;
...
RDL2_DSO_ATTR_DEFINE(rdl2::Light)
    ...
    attrLight = 
    sceneClass.declareAttribute<rdl2::SceneObject *>("light", nullptr, rdl2::FLAGS_NONE, rdl2::INTERFACE_LIGHT);
    sceneClass.setMetadata(attrLight, "comment", "The light on which to use the portal.");

    attrNormalized = sceneClass.declareAttribute<rdl2::Bool>("normalized", false);
    ...
    sceneClass.setGroup("Properties", attrLight);
