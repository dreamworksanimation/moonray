...
void
MetalGPUBox::getPrimitiveAabbs(std::vector<OptixAabb>* aabbs) const
{
...
int
MetalGPUBox::getFuncTableOffset() const
{
    return 1;
}

void
MetalGPUCurve::getPrimitiveAabbs(std::vector<OptixAabb>* aabbs) const
{
...
int
MetalGPUCurve::getFuncTableOffset() const
{
    switch (mBasis) {
    case BEZIER:
        return 2;
...
void
MetalGPUPoints::getPrimitiveAabbs(std::vector<OptixAabb>* aabbs) const
{
...
int
MetalGPUPoints::getFuncTableOffset() const
{
    return 2;
}

void
MetalGPUPoints::freeHostMemory()
{
    clearMemory(mHostPoints);
}

void
MetalGPUSphere::getPrimitiveAabbs(std::vector<OptixAabb>* aabbs) const
{
...
int
MetalGPUSphere::getFuncTableOffset() const
{
    return 3;
}
